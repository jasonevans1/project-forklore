...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-page">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-ticket-line bg-page">
            <flux:sidebar.header>
                <x-app-logo :sidebar="true" class="font-display" href="{{ route('dashboard') }}" wire:navigate />
        ...
        <!-- Mobile User Menu -->
        <flux:header class="border-b border-ticket-line bg-page lg:hidden">
